...
const translations = {
  ...
  "hero.subtitle":  { ru: "Откройте для себя Грузию вместе с нами. Мы предлагаем интересные туры по разным уголкам страны, комфортные путешествия и полную организацию, чтобы ваше путешествие было простым, приятным и незабываемым.", en: "Discover Georgia with us. We offer exciting tours to different corners of the country, comfortable travel and full organization, so that your journey is easy, enjoyable and unforgettable.", ka: "აღმოაჩინეთ საქართველო ჩვენთან ერთად. გთავაზობთ საინტერესო ტურებს ქვეყნის სხვადასხვა კუთხეში, კომფორტულ მოგზაურობას და სრულ ორგანიზებას, რათა თქვენი მოგზაურობა იყოს მარტივი, სასიამოვნო და დაუვიწყარი." },
  ...
  "services.faq.a3":        { ru: "Да, конечно! Все наши туры можно адаптировать под ваши пожелания — добавить локации, изменить время, выбрать другой ресторан. Просто сообщите нам заранее.", en: "Yes, of course! All our tours can be adapted to your wishes — add locations, change times, choose a different restaurant. Just let us know in advance.", ka: "დიახ, რა თქმა უნდა! ყველა ჩვენი ტური შეიძლება მოერგოს თქვენს სურვილებს — დაამატოთ ლოკაციები, შეცვალოთ დრო, აირჩიოთ სხვა რესტორანი. უბრალოდ წინასწარ გვაცნობეთ." },
  "services.faq.q4":        { ru: "Что брать с собой в тур?", en: "What should I bring on the tour?", ka: "რა უნდა წამოვიღო ტურზე?" },
  "services.faq.a4":        { ru: "Удобную обувь, солнцезащитные очки, головной убор и хорошее настроение! Для горных туров — тёплую одежду. Всё остальное мы обеспечиваем.", en: "Comfortable shoes, sunglasses, a hat and a good mood! For mountain tours — warm clothing. We provide everything else.", ka: "კომფორტული ფეხსაცმელი, მზის სათვალე, ქუდი და კარგი განწყობა! მთის ტურებისთვის — თბილი ტანსაცმელი. დანარჩენს ჩვენ უზრუნველვყოფთ." },
...
// ── SEASON PAGES ──
  ...
  "season.cta.tours":               { ru: "Смотреть туры",                en: "View Tours",                   ka: "ტურების ნახვა" },
  "season.highlights.tag":          { ru: "Особенности сезона",           en: "Season Highlights",            ka: "სეზონის თავისებურებები" },
  "season.weather.temp":            { ru: "Температура",                  en: "Temperature",                  ka: "ტემპერატურა" },
  "season.weather.sunny":           { ru: "Солнечные дни",                en: "Sunny Days",                   ka: "მზიანი დღეები" },
  "season.weather.permonth":        { ru: "дней в месяц",                 en: "days per month",               ka: "დღე თვეში" },
  "season.weather.rain":            { ru: "Осадки",                       en: "Rainfall",                     ka: "ნალექი" },
  "season.weather.moderate":        { ru: "Умеренные",                    en: "Moderate",                     ka: "ზომიერი" },
  "season.weather.humidity":        { ru: "Влажность",                    en: "Humidity",                     ka: "ტენიანობა" },
  "season.weather.comfortable":     { ru: "Комфортная",                   en: "Comfortable",                  ka: "კომფორტული" },

  // Spring
  "season.spring.hero.title":       { ru: "Весенняя <em>Грузия</em>",     en: "Spring <em>Georgia</em>",      ka: "გაზაფხულის <em>საქართველო</em>" },
  "season.spring.hero.subtitle":    { ru: "Время пробуждения природы, цветущих садов и зелёных долин. Откройте для себя Грузию в самое живописное время года.", en: "A time of nature awakening, blooming gardens and green valleys. Discover Georgia at its most picturesque time of year.", ka: "ბუნების გაღვიძების, აყვავებული ბაღებისა და მწვანე ხეობების დრო. აღმოაჩინეთ საქართველო წლის ყველაზე ფერადოვან პერიოდში." },
  "season.spring.period":           { ru: "Март - Май | Идеальный сезон", en: "March - May | Perfect Season",  ka: "მარტი - მაისი | იდეალური სეზონი" },
  "season.spring.highlights.title": { ru: "Почему стоит приехать весной", en: "Why Visit in Spring",           ka: "რატომ უნდა ეწვიოთ გაზაფხულზე" },
  "season.spring.highlights.subtitle": { ru: "Весна в Грузии — это идеальное сочетание комфортной погоды, живописных пейзажей и уникальных впечатлений", en: "Spring in Georgia offers the perfect combination of comfortable weather, scenic landscapes and unique experiences", ka: "გაზაფხული საქართველოში — კომფორტული ამინდის, ფერადი პეიზაჟებისა და უნიკალური შთაბეჭდილებების იდეალური შერწყმაა" },
  "season.spring.highlight1.title": { ru: "Цветущие сады",                en: "Blooming Gardens",             ka: "აყვავებული ბაღები" },
  "season.spring.highlight1.desc":  { ru: "Вся Грузия покрывается цветами — от горных лугов до виноградников Кахетии", en: "All of Georgia is covered with flowers — from mountain meadows to Kakheti vineyards", ka: "მთელი საქართველო ყვავილებით იფარება — მთის მდელოებიდან კახეთის ვენახებამდე" },
  "season.spring.highlight2.title": { ru: "Мягкий климат",                en: "Mild Climate",                 ka: "რბილი კლიმატი" },
  "season.spring.highlight2.desc":  { ru: "Комфортная температура 15-22°C — идеально для прогулок и экскурсий", en: "Comfortable temperature 15-22°C — perfect for walks and excursions", ka: "კომფორტული ტემპერატურა 15-22°C — იდეალურია გასეირნებისა და ექსკურსიებისთვის" },
  "season.spring.highlight3.title": { ru: "Меньше туристов",              en: "Fewer Tourists",               ka: "ნაკლები ტურისტი" },
  "season.spring.highlight3.desc":  { ru: "Низкий сезон позволяет наслаждаться достопримечательностями без толп", en: "Low season allows you to enjoy attractions without crowds", ka: "დაბალი სეზონი საშუალებას გაძლევთ ისიამოვნოთ ღირსშესანიშნაობებით ხალხმრავლობის გარეშე" },
  "season.spring.activities.title": { ru: "Чем заняться весной",          en: "What to Do in Spring",         ka: "რა გააკეთოთ გაზაფხულზე" },
  "season.spring.activities.desc":  { ru: "Весна открывает множество возможностей для активного отдыха и знакомства с грузинской культурой", en: "Spring opens up many opportunities for outdoor activities and exploring Georgian culture", ka: "გაზაფხული ხსნის მრავალ შესაძლებლობას აქტიური დასვენებისა და ქართული კულტურის გასაცნობად" },
  "season.spring.activity1.title":  { ru: "Горные походы",                en: "Mountain Hiking",              ka: "მთის ლაშქრობები" },
  "season.spring.activity1.desc":   { ru: "Идеальное время для треккинга в Сванетии и Казбеги", en: "Perfect time for trekking in Svaneti and Kazbegi", ka: "იდეალური დრო ლაშქრობისთვის სვანეთსა და ყაზბეგში" },
  "season.spring.activity2.title":  { ru: "Винные туры",                  en: "Wine Tours",                   ka: "ღვინის ტურები" },
  "season.spring.activity2.desc":   { ru: "Посещение виноделен в период цветения виноградников", en: "Visiting wineries during vineyard blooming season", ka: "მარნების მონახულება ვენახების აყვავების პერიოდში" },
  "season.spring.activity3.title":  { ru: "Исторические туры",            en: "Historical Tours",             ka: "ისტორიული ტურები" },
  "season.spring.activity3.desc":   { ru: "Комфортное время для посещения древних монастырей и крепостей", en: "Comfortable time to visit ancient monasteries and fortresses", ka: "კომფორტული დრო უძველესი მონასტრებისა და ციხესიმაგრეების მოსანახულებლად" },
  "season.spring.weather.temp":     { ru: "Днём комфортно",               en: "Comfortable daytime",          ka: "დღისით კომფორტული" },
  "season.spring.cta.title":        { ru: "Готовы к весеннему приключению?", en: "Ready for a Spring Adventure?", ka: "მზად ხართ გაზაფხულის თავგადასავლისთვის?" },
  "season.spring.cta.desc":         { ru: "Забронируйте тур прямо сейчас и откройте для себя весеннюю Грузию с опытными гидами DAMQ Travel", en: "Book a tour now and discover spring Georgia with experienced DAMQ Travel guides", ka: "დაჯავშნეთ ტური ახლავე და აღმოაჩინეთ გაზაფხულის საქართველო DAMQ Travel-ის გამოცდილ გიდებთან ერთად" },
  ...
  "season.summer.highlight1.desc":  { ru: "Пляжи Батуми, Кобулети и Уреки с уникальным магнитным песком", en: "Batumi, Kobuleti and Ureki beaches with unique magnetic sand", ka: "ბათუმის, ქობულეთისა და ურეკის პლაჟები უნიკალური მაგნიტური ქვიშით" },
  "season.summer.highlight2.title": { ru: "Горные маршруты",              en: "Mountain Routes",              ka: "მთის მარშრუტები" },
  "season.summer.highlight2.desc":  { ru: "Идеальное время для треккинга в Сванетии, Тушетии и Хевсуретии", en: "Perfect time for trekking in Svaneti, Tusheti and Khevsureti", ka: "იდეალური დრო ლაშქრობისთვის სვანეთში, თუშეთსა და ხევსურეთში" },
  "season.summer.highlight3.title": { ru: "Фестивали",                    en: "Festivals",                    ka: "ფესტივალები" },
  "season.summer.highlight3.desc":  { ru: "Музыкальные и культурные события под открытым небом", en: "Music and cultural events under the open sky", ka: "მუსიკალური და კულტურული ღონისძიებები ღია ცის ქვეშ" },
  "season.summer.activities.title": { ru: "Чем заняться летом",           en: "What to Do in Summer",         ka: "რა გააკეთოთ ზაფხულში" },
  "season.summer.activities.desc":  { ru: "Лето в Грузии предлагает разнообразие активностей от пляжного отдыха до горных приключений", en: "Summer in Georgia offers a variety of activities from beach holidays to mountain adventures", ka: "ზაფხული საქართველოში გთავაზობთ აქტივობების მრავალფეროვნებას პლაჟზე დასვენებიდან მთის თავგადასავლებამდე" },
  "season.summer.activity1.title":  { ru: "Пляжный отдых",                en: "Beach Vacation",               ka: "პლაჟზე დასვენება" },
  "season.summer.activity1.desc":   { ru: "Золотые пляжи Аджарии и курорты Черного моря", en: "Golden beaches of Adjara and Black Sea resorts", ka: "აჭარის ოქროსფერი პლაჟები და შავი ზღვის კურორტები" },
  "season.summer.activity2.title":  { ru: "Рафтинг",                      en: "Rafting",                      ka: "რაფტინგი" },
  "season.summer.activity2.desc":   { ru: "Экстремальные сплавы по горным рекам", en: "Extreme rafting on mountain rivers", ka: "ექსტრემალური სპლავები მთის მდინარეებზე" },
  "season.summer.activity3.title":  { ru: "Винные дегустации",            en: "Wine Tastings",                ka: "ღვინის დეგუსტაციები" },
  "season.summer.activity3.desc":   { ru: "Посещение виноделен в разгар лета", en: "Visiting wineries in the middle of summer", ka: "მარნების მონახულება ზაფხულის შუა პერიოდში" },
  "season.weather.sea":             { ru: "Море",                         en: "Sea",                          ka: "ზღვა" },
  "season.summer.weather.temp":     { ru: "Жарко и солнечно",             en: "Hot and sunny",                ka: "ცხელი და მზიანი" },
  "season.summer.weather.sea":      { ru: "Температура воды",             en: "Water temperature",            ka: "წყლის ტემპერატურა" },
  "season.weather.uv":              { ru: "UV индекс",                    en: "UV Index",                     ka: "UV ინდექსი" },
  "season.summer.weather.uv":       { ru: "Высокий",                      en: "High",                         ka: "მაღალი" },
  "season.summer.cta.title":        { ru: "Готовы к летнему приключению?", en: "Ready for a Summer Adventure?", ka: "მზად ხართ ზაფხულის თავგადასავლისთვის?" },
  "season.summer.cta.desc":         { ru: "Забронируйте тур прямо сейчас и откройте для себя летнюю Грузию с опытными гидами DAMQ Travel", en: "Book a tour now and discover summer Georgia with experienced DAMQ Travel guides", ka: "დაჯავშნეთ ტური ახლავე და აღმოაჩინეთ ზაფხულის საქართველო DAMQ Travel-ის გამოცდილ გიდებთან ერთად" },

  // Autumn
  "season.autumn.hero.title":       { ru: "Осенняя <em>Грузия</em>",      en: "Autumn <em>Georgia</em>",      ka: "შემოდგომის <em>საქართველო</em>" },
  "season.autumn.hero.subtitle":    { ru: "Время сбора винограда, золотых пейзажей и праздника Ртвели. Погрузитесь в атмосферу грузинского гостеприимства.", en: "Time of grape harvest, golden landscapes and the Rtveli celebration. Immerse yourself in Georgian hospitality.", ka: "ყურძნის კრეფის, ოქროსფერი პეიზაჟებისა და რთველის ზეიმის დრო. ჩაეფალით ქართულ სტუმართმოყვარეობაში." },
  "season.autumn.period":           { ru: "Сентябрь - Ноябрь | Винный сезон", en: "September - November | Wine Season", ka: "სექტემბერი - ნოემბერი | ღვინის სეზონი" },
  "season.autumn.highlights.title": { ru: "Почему стоит приехать осенью", en: "Why Visit in Autumn",           ka: "რატომ უნდა ეწვიოთ შემოდგომაზე" },
  "season.autumn.highlights.subtitle": { ru: "Осень в Грузии — это золотые виноградники, праздник урожая и самое вкусное время года", en: "Autumn in Georgia means golden vineyards, harvest celebrations and the most delicious time of year", ka: "შემოდგომა საქართველოში — ოქროსფერი ვენახები, მოსავლის ზეიმი და წლის ყველაზე გემრიელი დრო" },
  "season.autumn.highlight1.title": { ru: "Праздник Ртвели",              en: "Rtveli Festival",              ka: "რთველის დღესასწაული" },
  "season.autumn.highlight1.desc":  { ru: "Традиционный сбор винограда и изготовление вина в квеври", en: "Traditional grape harvest and winemaking in qvevri", ka: "ყურძნის ტრადიციული კრეფა და ღვინის დაყენება ქვევრში" },
  "season.autumn.highlight2.title": { ru: "Золотые пейзажи",              en: "Golden Landscapes",            ka: "ოქროსფერი პეიზაჟები" },
  "season.autumn.highlight2.desc":  { ru: "Виноградники и леса окрашиваются в золотые и багряные тона", en: "Vineyards and forests turn golden and crimson", ka: "ვენახები და ტყეები ოქროსფერ და ალისფერ ფერებში იღებავება" },
  "season.autumn.highlight3.title": { ru: "Тёплая погода",                en: "Warm Weather",                 ka: "თბილი ამინდი" },
  "season.autumn.highlight3.desc":  { ru: "Комфортные 18-25°C и мягкие солнечные дни", en: "Comfortable 18-25°C and mild sunny days", ka: "კომფორტული 18-25°C და რბილი მზიანი დღეები" },
  "season.autumn.activities.title": { ru: "Чем заняться осенью",          en: "What to Do in Autumn",         ka: "რა გააკეთოთ შემოდგომაზე" },
  "season.autumn.activities.desc":  { ru: "Осень — идеальное время для знакомства с винной культурой Грузии и живописными пейзажами", en: "Autumn is the perfect time to explore Georgia's wine culture and scenic landscapes", ka: "შემოდგომა — იდეალური დროა საქართველოს ღვინის კულტურისა და ფერადი პეიზაჟების გასაცნობად" },
  "season.autumn.activity1.title":  { ru: "Участие в Ртвели",             en: "Join Rtveli",                  ka: "რთველში მონაწილეობა" },
  "season.autumn.activity1.desc":   { ru: "Сбор винограда и давка вина ногами по традиции", en: "Grape picking and traditional foot pressing", ka: "ყურძნის კრეფა და ტრადიციული ფეხით წნეხვა" },
  ...
  "season.autumn.cta.title":        { ru: "Готовы к осеннему приключению?", en: "Ready for an Autumn Adventure?", ka: "მზად ხართ შემოდგომის თავგადასავლისთვის?" },
  "season.autumn.cta.desc":         { ru: "Забронируйте тур прямо сейчас и станьте частью праздника Ртвели с опытными гидами DAMQ Travel", en: "Book a tour now and become part of the Rtveli celebration with experienced DAMQ Travel guides", ka: "დაჯავშნეთ ტური ახლავე და გახდით რთველის ზეიმის ნაწილი DAMQ Travel-ის გამოცდილ გიდებთან ერთად" },

  // Winter
  "season.winter.hero.title":       { ru: "Зимняя <em>Грузия</em>",       en: "Winter <em>Georgia</em>",      ka: "ზამთრის <em>საქართველო</em>" },
  "season.winter.hero.subtitle":    { ru: "Время горнолыжных приключений, термальных источников и новогодних праздников. Снежные вершины и тёплое гостеприимство.", en: "Time for ski adventures, thermal springs and New Year celebrations. Snowy peaks and warm hospitality.", ka: "სათხილამურო თავგადასავლების, თერმული წყაროებისა და საახალწლო დღესასწაულების დრო. თოვლიანი მწვერვალები და თბილი სტუმართმოყვარეობა." },
  "season.winter.period":           { ru: "Декабрь - Февраль | Горнолыжный сезон", en: "December - February | Ski Season", ka: "დეკემბერი - თებერვალი | სათხილამურო სეზონი" },
  "season.winter.highlights.title": { ru: "Почему стоит приехать зимой",  en: "Why Visit in Winter",          ka: "რატომ უნდა ეწვიოთ ზამთარში" },
  "season.winter.highlights.subtitle": { ru: "Зима в Грузии — это горнолыжные курорты мирового класса, целебные источники и праздничная атмосфера", en: "Winter in Georgia offers world-class ski resorts, healing springs and festive atmosphere", ka: "ზამთარი საქართველოში — მსოფლიო დონის სათხილამურო კურორტები, სამკურნალო წყაროები და სადღესასწაულო ატმოსფერო" },
  "season.winter.highlight1.title": { ru: "Гудаури и Бакуриани",          en: "Gudauri & Bakuriani",          ka: "გუდაური და ბაკურიანი" },
  "season.winter.highlight1.desc":  { ru: "Современные горнолыжные курорты с отличными трассами", en: "Modern ski resorts with excellent slopes", ka: "თანამედროვე სათხილამურო კურორტები შესანიშნავი ტრასებით" },
  "season.winter.highlight2.title": { ru: "Термальные источники",         en: "Thermal Springs",              ka: "თერმული წყაროები" },
  "season.winter.highlight2.desc":  { ru: "Природные горячие источники для релаксации", en: "Natural hot springs for relaxation", ka: "ბუნებრივი ცხელი წყაროები დასვენებისთვის" },
  ...
  "season.winter.activity2.desc":   { ru: "Расслабление в серных банях Тбилиси", en: "Relaxation in Tbilisi sulfur baths", ka: "დასვენება თბილისის გოგირდის აბანოებში" },
  "season.winter.activity3.title":  { ru: "Культурные туры",              en: "Cultural Tours",               ka: "კულტურული ტურები" },
  "season.winter.activity3.desc":   { ru: "Посещение древних монастырей без толп", en: "Visit ancient monasteries without crowds", ka: "უძველესი მონასტრების მონახულება ხალხმრავლობის გარეშე" },
  "season.winter.weather.temp":     { ru: "В зависимости от региона",     en: "Depending on region",          ka: "რეგიონის მიხედვით" },
  "season.winter.weather.snow":     { ru: "Снег",                         en: "Snow",                         ka: "თოვლი" },
  "season.winter.weather.mountains":{ ru: "В горах",                      en: "In mountains",                 ka: "მთებში" },
  "season.winter.weather.slopes":   { ru: "Трассы",                       en: "Slopes",                       ka: "ტრასები" },
  "season.winter.weather.km":       { ru: "км трасс",                     en: "km of slopes",                 ka: "კმ ტრასა" },
  "season.winter.weather.thermal":  { ru: "Термы",                        en: "Thermal",                      ka: "თერმა" },
  "season.winter.weather.water":    { ru: "Вода круглый год",             en: "Water year-round",             ka: "წყალი მთელი წლის მანძილზე" },
  "season.winter.cta.title":        { ru: "Готовы к зимнему приключению?", en: "Ready for a Winter Adventure?", ka: "მზად ხართ ზამთრის თავგადასავლისთვის?" },
  "season.winter.cta.desc":         { ru: "Забронируйте тур прямо сейчас и откройте для себя зимнюю Грузию с опытными гидами DAMQ Travel", en: "Book a tour now and discover winter Georgia with experienced DAMQ Travel guides", ka: "დაჯავშნეთ ტური ახლავე და აღმოაჩინეთ ზამთრის საქართველო DAMQ Travel-ის გამოცდილ გიდებთან ერთად" },
